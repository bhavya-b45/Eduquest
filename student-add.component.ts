 	...
 	createForm(data){
 		if (data == null) {
 			this.studentAddForm = this.formBuilder.group({
				 ...
				 father_name: ['',  [Validators.required,Validators.minLength(3),Validators.maxLength(50)]],
				 mother_name: ['',  [Validators.required,Validators.minLength(3),Validators.maxLength(50)]],
				 ...
				 roll_no: ['',  [Validators.required, ValidationService.roll_noValidator]]
