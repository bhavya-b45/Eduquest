...
export class LoginComponent implements OnInit {
	...
	constructor(private formBuilder: FormBuilder,private router: Router, private userService:UserService,private toastr: ToastrService) { 
		this.loginForm = this.formBuilder.group({
			email: ['admin@eduquest.com',  [Validators.required, ValidationService.emailValidator]],
			password: ['eduquest123',[Validators.required, ValidationService.passwordValidator]]
		});
	}
	ngOnInit() {
